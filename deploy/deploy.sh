...
echo "       --region ${REGION}"
echo ""
echo "     LAMBDA_ARN=\"arn:aws:lambda:${REGION}:YOUR_ACCOUNT_ID:function:${FUNCTION_NAME}\""
echo "     cat > /tmp/claude-news-analyzer-daily-target.json <<EOF"
echo "     ["
echo "       {"
echo "         \"Id\": \"1\","
echo "         \"Arn\": \"\${LAMBDA_ARN}\","
echo "         \"Input\": \"{\\\"analysis_type\\\":\\\"daily\\\"}\""
echo "       }"
echo "     ]"
echo "     EOF"
echo ""
